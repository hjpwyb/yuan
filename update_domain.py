...
# 主程序
def main():
    base_url = "http://7390hsck.cc/vodtype/9-2.html"  # 要测试的基本 URL
    valid_links = []  # 存储有效链接

    # 进行试错，依次更换URL中的数字部分
    for i in range(7390, 7550):  # 假设你想测试7465ck.cc到7474ck.cc这几个域名
        url_to_test = base_url.replace("7465hsck.cc", f"{i}hsck.cc")
